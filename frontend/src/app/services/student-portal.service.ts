...
export interface Achievement {
  ...
  dateEarned: string; xpReward: number; icon: string; earned: boolean;
}
...
export class StudentPortalService {
  ...
  private achievements: Achievement[] = [
    {id:'ach1',title:'Math Master',      description:'Score 90%+ in 5 consecutive math tests',  category:'academic',     dateEarned:'2025-05-20',xpReward:200,icon:'📐',earned:true},
    {id:'ach2',title:'Perfect Week',     description:'100% attendance for an entire week',       category:'attendance',   dateEarned:'2025-06-02',xpReward:150,icon:'⭐',earned:true},
    {id:'ach3',title:'Team Player',      description:'Complete 10 group projects',               category:'participation',dateEarned:'2025-04-10',xpReward:100,icon:'🤝',earned:true},
    {id:'ach4',title:'Challenge Champ',  description:'Win 5 challenges',                         category:'challenge',    dateEarned:'2025-05-15',xpReward:300,icon:'🏆',earned:true},
    {id:'ach5',title:'Reading Star',     description:'Complete 20 reading assignments',          category:'academic',     dateEarned:'',          xpReward:180,icon:'📚',earned:false},
    {id:'ach6',title:'30-Day Streak',    description:'Maintain a 30-day learning streak',        category:'attendance',   dateEarned:'',          xpReward:250,icon:'🔥',earned:false},
    {id:'ach7',title:'Science Whiz',     description:'Score 90%+ in 5 science tests',            category:'academic',     dateEarned:'',          xpReward:200,icon:'🔬',earned:false},
    {id:'ach8',title:'First Challenge',  description:'Complete your first challenge',             category:'challenge',    dateEarned:'2025-03-01',xpReward:50, icon:'🚀',earned:true},
  ];
